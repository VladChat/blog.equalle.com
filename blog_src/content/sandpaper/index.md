...
layout: "page"
type: "page"
description: "Professional wet/dry silicon carbide sandpaper for flawless finishing on wood, metal, auto body, and more."
summary: "Precision-crafted abrasive sheets for smooth, consistent results — Wet or Dry Use."
draft: false
---
...
<section class="nko-section nko-features" aria-label="Why Choose eQualle">
  ...
  <div class="features-grid">
    <div class="feature-item">
      ...
      <p class="feature-text">Cuts fast and clean for consistent results on every surface.</p>
    </div>
    <div class="feature-item">
      <h3 class="feature-title">Wet or Dry Use</h3>
      <p class="feature-text">Sand with water for dust control and a finer finish — or use dry for speed.</p>
    </div>
    <div class="feature-item">
      <h3 class="feature-title">Wide Grit Range</h3>
      <p class="feature-text">From P60 for heavy removal to P3000 for mirror-polishing precision.</p>
    </div>
    <div class="feature-item">
      <h3 class="feature-title">Versatile & Reliable</h3>
      <p class="feature-text">Ideal for wood, auto body, metal, resin, and plastic applications.</p>
    </div>
  </div>
</section>
...
<section class="nko-section nko-cta" aria-label="Shop eQualle Sandpaper">
  ...
  <div class="cta-text">
    ...
    <p class="nko-lead">Pick your grit, prep your surface, and experience the difference of true professional sandpaper.</p>
...
Smooth results start with the right grit — choose eQualle and sand smarter.
</p>
