...
<figure class="brand-image">
  <img src="/images/brand/05.webp" alt="Surface Leveling: Sanding Uneven Wood Panels Flat — Sandpaper Sheets" loading="lazy" decoding="async">
</figure>
...
1. Level with your coarsest chosen grit using a long block, with-grain strokes.
2. Vacuum and re-map with pencil. If the pencil erases uniformly with a light pass, you’re flat.
3. Rotate your block orientation 10–15 degrees during mid-grits (150–180) to reveal lingering coarse scratches, then finish the set with dead-with-grain passes.
4. After 220, stop. Further grits can burnish early and interfere with finish adhesion.

*According to a [ article](https://sawmillcreek.org/showthread.php?170998-Woodmaster-Drum-vs-Grizzly-Widebelt-Sander)*
...
<figure class="brand-image">
  <img src="/images/brand/04.webp" alt="Surface Leveling: Sanding Uneven Wood Panels Flat — Sandpaper Sheets" loading="lazy" decoding="async">
</figure>
...
<blockquote>There’s a practical walk-through I recommend: a hand-sanding demonstration focused on getting truly flat panels without any fancy machinery. It shows how to use long blocks, body position, and pencil maps to achieve that crisp flatness and clean edges.</blockquote>
<div class="video-embed" style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;border-radius:12px;"><iframe src="https://www.youtube.com/embed/4CKzaILOzuE" title="How to Sand a Surface Perfectly Flat by Hand" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;"></iframe></div>
<p style="margin-top:0.5rem;font-size:0.95rem;opacity:0.85;">Video source: <a href="https://www.youtube.com/watch?v=4CKzaILOzuE" target="_blank" rel="noopener nofollow">How to Sand a Surface Perfectly Flat by Hand</a></p><div class="equalle-product-link"><p><a href="https://equalle.com/products/sandpaper-100-sheets-grit-500" target="_blank">500 Grit Sandpaper Sheets (100-pack)</a> — 9x11 in Silicon Carbide Abrasive for Wet or Dry Use — Soft-action abrasive for micro-smoothing metal, resin, or primer coatings where precision and uniformity are key. (Professional Grade).</p></div>
